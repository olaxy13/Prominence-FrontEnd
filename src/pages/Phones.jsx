...
const phoneData = [
  { id: 1, name: 'iPhone 15', brand: 'Apple', price: 999, image: 'https://m.media-amazon.com/images/I/71d7rfSl0wL._AC_UY218_.jpg' },
  { id: 2, name: 'Galaxy S24', brand: 'Samsung', price: 899, image: 'https://m.media-amazon.com/images/I/71qZy8c7QwL._AC_UY218_.jpg' },
  { id: 3, name: 'Pixel 8', brand: 'Google', price: 799, image: 'https://m.media-amazon.com/images/I/81Qw5Zl+JwL._AC_UY218_.jpg' },
  { id: 4, name: 'OnePlus 12', brand: 'OnePlus', price: 749, image: 'https://m.media-amazon.com/images/I/61Qe0euJJZL._AC_UY218_.jpg' },
  { id: 5, name: 'iPhone SE', brand: 'Apple', price: 429, image: 'https://m.media-amazon.com/images/I/81-fNm5gQML._AC_UY218_.jpg' },
  { id: 6, name: 'Galaxy A55', brand: 'Samsung', price: 499, image: 'https://m.media-amazon.com/images/I/71p1r6rQGGL._AC_UY218_.jpg' },
];
    ...
    <div className="flex flex-wrap md:flex-nowrap gap-8 p-4 md:p-8 bg-gray-50 min-h-screen">
      ...
      <aside className="w-full h-fit md:w-64 mb-6 md:mb-0 bg-white rounded-lg shadow p-4">
        ...
        <div className="space-y-2">
          {brands.map((brand) => (
            <label key={brand} className="flex items-center gap-2 cursor-pointer text-gray-700">
              <input
                type="checkbox"
